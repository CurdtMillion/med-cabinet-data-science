...
model = pickle.load(open("../data/interim/nearest_neighbors_model.sav", "rb"))
transformer = pickle.load(open("../data/interim/transformer.sav", "rb"))
strains = pd.read_csv("../data/processed/nn_model_strains.csv")
